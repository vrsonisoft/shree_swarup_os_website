...
<div class="legal-page">
  ...
  <div class="legal-container">
    ...
    <aside class="legal-sidebar">
      ...
      <template id="sidebar-static-fallback">
        <li><a href="#sec-1">1. Refund Overview</a></li>
        <li><a href="#sec-2">2. Refund Eligibility</a></li>
        <li><a href="#sec-3">3. Subscription Cancellations</a></li>
        <li><a href="#sec-4">4. Refund Request Process</a></li>
        <li><a href="#sec-5">5. Billing Contact</a></li>
      </template>
    </aside>
    ...
    <main class="legal-content" id="legal-content-body">
      ...
      <div id="legal-loader" style="padding:60px 20px;text-align:center;">
        ...
        <div style="font-size:14px;font-weight:600;color:var(--gray);">Loading Refund Policy...</div>
      </div>

      <template id="content-static-fallback">
        <div class="legal-callout">
          <p>💳 <strong>Fair Billing Policy:</strong> We strive to ensure complete satisfaction with our restaurant management platform. This Refund Policy outlines the terms for subscription refunds and billing adjustments.</p>
        </div>

        <section id="sec-1" class="legal-section">
          <h2><span class="num">1</span> Refund Overview</h2>
          <p>TableTrack offers subscription plans for our restaurant software. Because our software is provided on a software-as-a-service (SaaS) basis with trial options, payments are generally non-refundable except under specified conditions.</p>
        </section>

        <section id="sec-2" class="legal-section">
          <h2><span class="num">2</span> Refund Eligibility</h2>
          <p>Refunds may be issued under the following circumstances:</p>
          <ul>
            <li><strong>Duplicate Charges:</strong> In the event of an accidental duplicate transaction or billing system error.</li>
            <li><strong>Major System Outage:</strong> Prolonged unannounced platform downtime exceeding 48 consecutive hours during active subscription periods.</li>
            <li><strong>Money-Back Guarantee Period:</strong> If requested within 7 days of initial subscription setup for first-time customers.</li>
          </ul>
        </section>

        <section id="sec-3" class="legal-section">
          <h2><span class="num">3</span> Subscription Cancellations</h2>
          <p>You may cancel your recurring subscription at any time from your billing dashboard. Once cancelled, your account will remain active until the end of your current paid billing period.</p>
        </section>

        <section id="sec-4" class="legal-section">
          <h2><span class="num">4</span> Refund Request Process</h2>
          <p>To request a billing review or refund, please submit your transaction invoice ID and reason to <strong>billing@tabletrack.com</strong>. Approved refunds will be processed to your original payment method within 5–7 business days.</p>
        </section>

        <section id="sec-5" class="legal-section">
          <h2><span class="num">5</span> Billing Contact</h2>
          <p>If you have any questions regarding billing statements or charges, please contact our financial operations team at <strong>billing@tabletrack.com</strong>.</p>
        </section>
      </template>
  ...
  <section class="legal-cta">
    <h3>Have Questions About Billing?</h3>
    <p>Our support team is available to assist with subscription adjustments and invoicing inquiries.</p>
    <a href="/about-us">Contact Billing Support →</a>
  </section>

</div>

<script>
// ── DYNAMIC LEGAL POLICY FETCH (Refund Policy) ──
(function() {
  const POLICY_TYPE = 'refund-policy';
